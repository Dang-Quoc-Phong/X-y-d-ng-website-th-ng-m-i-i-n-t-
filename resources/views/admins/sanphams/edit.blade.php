                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-8">   
                                ...
                                <div class="mb-3">
                                  ...
                                  <img id="img_danh_muc" src="{{Storage::url($sanPham->hinh_anh)}}" alt="" style=" width: 150px; ">
                                </div>
 ...
 <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var quill = new Quill("#quill-editor", {
         ...
         // Cập nhật lại tẽtarea ẩn khi nội dung của quill-editor thay đổi
 ...
 <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('add-row').addEventListener('click', function() {
            ...
            var newRou = document.createElement('tr');
    
            newRou.innerHTML = ` 
                <td class="d-flex align-items-center">
                    <img id="preview_${rowCount}" 
                      src="https://i.pinimg.com/564x/36/82/49/3682496b6bb48ca7d64242a08157019f.jpg" 
                       alt="Hình ảnh sản phẩm" style=" width: 50px;" class="me-3">
