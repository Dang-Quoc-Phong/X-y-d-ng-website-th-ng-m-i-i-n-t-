        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{route('admins.sanphams.create')}}" class="btn btn-success"> <i data-feather="plus-square"></i> Thêm mới sản phẩm</a>
                </div><!-- end card header -->
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ Storage::url($item->hinh_anh) }}" width="150px" alt="Hình ảnh của {{ $item->ten_san_pham }}">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admins.sanphams.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Bạn có đồng ý xóa hay không?')">
                                            @csrf
                                            @method('DELETE')
